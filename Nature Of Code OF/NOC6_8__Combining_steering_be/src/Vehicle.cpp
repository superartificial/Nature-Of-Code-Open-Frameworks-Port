...
void Vehicle::applyBehaviors(std::vector<Vehicle> vehicles) {
    ofVec2f separateF = separate(vehicles);
    ofVec2f seekF = seek(ofVec2f(ofGetMouseX(),ofGetMouseY()));
...
ofVec2f Vehicle::attract(int x,int y) {
...
ofVec2f Vehicle::separate(std::vector<Vehicle> vehicles)
{
